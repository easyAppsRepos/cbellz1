...
var ReservaPage = (function () {
    ...
    ReservaPage.prototype.getFechaFormat = function () {
        if (this.fechaSeleccionada) {
            ...
            return __WEBPACK_IMPORTED_MODULE_4_moment__(this.fechaSeleccionada, 'YYYY-MM-DD').format('LL');
        }
        else {
