...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ayuda__ = __webpack_require__(456);
...
var AyudaPage = (function () {
    ...
    AyudaPage.prototype.ionViewDidLoad = function () {
        ...
        this.information = [{ nombre: 'Reservas y Citas', id: 1, respuesta: 'Puedes ver el estado de tus reservaciones en la pestaña Reservaciones', open: true },
            { nombre: 'Uso de cupones', id: 2, respuesta: 'Para hacer uso de nuestros cupones solo debes ingresar uno y el descuento se aplicará automaticamente en tu proxima reserva', open: true },
            { nombre: 'Como puedo formar parte de BeYou', id: 3, respuesta: 'Para formar parte de BeYou negocios debes contactarnos al email email@contacto.com o por medio del telefono 39393939', open: true }];
