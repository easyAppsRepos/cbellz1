...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ajustes__ = __webpack_require__(454);
...
var AjustesPage = (function () {
    ...
    AjustesPage.prototype.bnegocios = function () {
        var alert = this.alertCtrl.create({
            ...
            subTitle: 'Te interesa ser parte de BeYou? Ponte en contacto a la brevedad posible! <br><br> Email: email@beyou.com <br>  Telefono: 24242424',
            buttons: ['Cerrar']
        });
        alert.present();
    };
