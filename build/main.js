...
var ApiProvider = (function () {
    ...
    ApiProvider.prototype.categoriasHome = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.api2 + '/categoriasHome2').subscribe(function (data) {
                console.log('d');
                resolve(data);
            }, function (err) {
                console.log(err);
    ...
    ApiProvider.prototype.ofertasActivas = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.post(_this.api2 + '/ofertasActivas', { headers: { 'Content-Type': 'application/json' } }).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
