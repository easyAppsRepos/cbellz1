...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__perfil_centro__ = __webpack_require__(490);
...
var PerfilCentroPage = (function () {
    function PerfilCentroPage(navCtrl, alertCtrl, DomSanitizer, navParams, http, modalCtrl, apiProvider, loadingController, events, zone) {
  ...
  */
    ...
    PerfilCentroPage.prototype.getHorarioDia = function (dia) {
        var ret = '';
        var result = this.horarioActivo.filter(function (word) { return word.diaSemana == dia; })[0];
        console.log(result);
        if (result) {
            if (result.estado == 1) {
    ...
    PerfilCentroPage.prototype.getCentroInfo = function (idCentro) {
        var _this = this;
        var loading = this.loadingController.create({ content: "Cargando...", cssClass: "my-loading" });
        loading.present();
        var d = new Date();
        var numDia = d.getDay();
        if (numDia == 6) {
        ...
        this.apiProvider.getCentroInfo(dataPost)
            ...
            if (data) {
                ...
                _this.horarioActivo = data['horario'];
                /*
                ...
                */
                var itemDate_1 = [];
                serviArr.forEach(function (i, index) {
                    //idServReal
                    if (_this.navParams.get('idServReal') && _this.navParams.get('idServReal') > 0) {
                        var first = _this.navParams.get('idServReal');
                    ...
                    if (item.open) {
                        itemDate_1.unshift(item);
                    }
                    else {
                        itemDate_1.push(item);
                    }
                });
                console.log(itemDate_1);
                //actualiuza ngzone
                _this.zone.run(function () {
                    //this.imageFileName = imageData;
                    _this.information = itemDate_1;
    ...
    PerfilCentroPage.prototype.reintentarAlert = function (funcionEnviar) {
    ...
    PerfilCentroPage.prototype.toggleSelect22 = function (i, j) {
        ...
        if (this.information[i].children[j].selected == true) {
            this.apiProvider.sacarProducto(this.information[i].children[j].idServicio)
                .then(function (data) {
                console.log(data);
                _this.information[i].children[j].selected = false;
            });
        }
        else {
            this.apiProvider.addProducto(this.information[i].children[j])
                .then(function (data) {
                console.log(data);
                _this.information[i].children[j].selected = true;
            });
        }
        console.log(this.arraySelected);
    };
    ...
    PerfilCentroPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["c" /* DomSanitizer */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["c" /* DomSanitizer */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ModalController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ModalController"]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_5__providers_api_api__["a" /* ApiProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__providers_api_api__["a" /* ApiProvider */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["Events"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["Events"]) === "function" && _j || Object, typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"]) === "function" && _k || Object])
    ], PerfilCentroPage);
