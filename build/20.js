...
var LoginPage = (function () {
    function LoginPage(navCtrl, navParams, modalCtrl, formBuilder, loadingCtrl, events, alertCtrl, viewCtrl, apiProvider, sanitizer) {
        ...
        this.authForm = formBuilder.group({
            ...
            telefono: [''],
            email: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].required]), this.checkUsername2.bind(this)],
