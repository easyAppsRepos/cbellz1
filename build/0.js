...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reserva__ = __webpack_require__(478);
...
var ReservaPage = (function () {
    function ReservaPage(navCtrl, navParams, modalCtrl, loadingCtrl, events, apiProvider, cdr, zone) {
        var _this = this;
    ...
    ReservaPage.prototype.goReserva = function (fechaSeleccionada, horaSeleccionada) {
        ...
        var dataE = { 'idCuponCliente': this.navParams.get('cupon'), 'fechaInicio': fechaInicio, 'fechaFinal': fechaFinal, 'fecha': fechaSeleccionada, 'hora': horaSeleccionada, 'horaF': this.horaFinalizacion, 'centro': this.navParams.get('centro'), 'idEmpleado': this.staffSeleccionado || 0 };
