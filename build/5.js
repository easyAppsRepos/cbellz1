...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__perfil_centro__ = __webpack_require__(465);
...
var PerfilCentroPage = (function () {
    ...
    PerfilCentroPage.prototype.goReserva = function () {
        ...
        var dataE = { 'servicios': this.arraySelected, 'idCentro': this.navParams.get('idCentro'), centro: this.dataCentro };
        console.log(dataE);
