                ...
                _this.apiProvider.getCentrosMapa({ lat: _this.myPosition.latitude, lon: _this.myPosition.longitude })
                    ...
                    data.forEach(function (element, index) {
                        ...
                        frame.innerHTML = ["<span style='color: #2FD99B;font-size: 17px;'><b>" + element.nombre + "</b></span><br>",
                            "<span style=\"display: block;font-size: 11px;\">\n        <ion-icon  " + (element.rate >= 1 ? "class='ratingStar'" : "") + " name=\"star\"></ion-icon>\n        <ion-icon " + (element.rate >= 2 ? "class='ratingStar'" : "") + " name=\"star\"></ion-icon>\n        <ion-icon " + (element.rate >= 3 ? "class='ratingStar'" : "") + "  name=\"star\"></ion-icon>\n        <ion-icon  " + (element.rate >= 4 ? "class='ratingStar'" : "") + " name=\"star\"></ion-icon>\n        <ion-icon " + (element.rate >= 5 ? "class='ratingStar'" : "") + " name=\"star\"></ion-icon>\n        </span>",
