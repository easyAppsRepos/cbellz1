                ...
                _this.apiProvider.getCentrosMapa({ lat: _this.myPosition.latitude, lon: _this.myPosition.longitude })
                    ...
                    data.forEach(function (element, index) {
                        ...
                        frame.innerHTML = ["<span style='color: #2FD99B;font-size: 17px;'><b>" + element.nombre + "</b></span><br>",
                            "<span style='margin-right: 21px;  color: #888;font-size: 17px;'><ion-icon name='md-star' role='img' style='    margin-right: 8px;\n          color: rgb(249,199,53);font-size: 21px;vertical-align: middle;' class='icon icon-ios ion-md-star'> </ion-icon>" + (element.rate ? element.rate.toFixed(1) : '-') + " (" + (element.cantRate ? element.cantRate : '0') + ")</span>",
