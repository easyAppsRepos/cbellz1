...
var CuentaPage = (function () {
    function CuentaPage(DomSanitizer, navCtrl, navParams, modalCtrl, alertCtrl, loadingCtrl, events, apiProvider, storage) {
        var _this = this;
    ...
    CuentaPage.prototype.uploadFile = function () {
        ...
        */
        ...
        ft.upload(this.imageURI, 'http://50.116.17.150:3000/editarCF', function (data) {
            console.log(data);
