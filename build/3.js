...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lista_servicios__ = __webpack_require__(466);
    ...
    ListaServiciosPage.prototype.buscarServicios = function (id, continuar) {
        ...
        this.storage.get('coorLBY').then(function (value) {
            ...
            if (_this.latitudePerson == 0 && continuar) {
                ...
                _this.categoriaSeleccionada = id;
                console.log(_this.categoriaSeleccionada);
                var filtro = {
                    lat: _this.latitudePerson,
                    lon: _this.longitudePerson,
                    idCategoria: id
                };
                _this.apiProvider.buscarServicios(filtro)
                    .then(function (data) {
                    console.log(data);
