...
var ListaServiciosPage = (function () {
  ...
  */
        ...
        navigator.geolocation.getCurrentPosition(function (pos) {
            ...
            loading.dismissAll();
            _this.presentAlert();
            _this.buscarServicios(id, false);
        }, { enableHighAccuracy: true, timeout: 30000 });
    };
