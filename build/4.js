...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cupones__ = __webpack_require__(456);
...
var CuponesPage = (function () {
    ...
    CuponesPage.prototype.getCupones = function (idCliente) {
        ...
        console.log(dataE);
        this.apiProvider.getCupones(dataE)
            .then(function (data) {
            console.log(data);
            if (data) {
                _this.cupones = data || [];
