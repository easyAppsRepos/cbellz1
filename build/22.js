...
var DetalleReservaPage = (function () {
    ...
    DetalleReservaPage.prototype.getFechaFormat = function (eee) {
        if (eee) {
            ...
            return __WEBPACK_IMPORTED_MODULE_4_moment__(eee, 'YYYY-MM-DD').format('LL');
        }
        else {
            return ' - ';
        }
        ...
        this.apiProvider.getDataCita(dataE)
            ...
            if (data) {
                _this.zone.run(function () {
                    ...
                    if (_this.dataCita.estado == 3 && window.plugins && window.plugins.NativeAudio) {
